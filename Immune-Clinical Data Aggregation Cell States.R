...
HatzisD_immune <- read_xlsx("hatzis-discovery InstaPrism results tpm.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
HatzisV_immune <- read_xlsx("hatzis-validation InstaPrism results tpm.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
metabric_immune <- read_xlsx("metabric InstaPrism results tpm.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
scanb_immune <- read_xlsx("SCANB InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
smc_immune <- read_xlsx("SMC InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
tcga_immune <- read_xlsx("TCGA InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
mbc_immune <- read_xlsx("MBC InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
ispy_immune <- read_xlsx("ispy InstaPrism results tpm.xlsx", sheet = 3)
...
#Derouane cleaning####
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
derouane_immune <- read_xlsx("Derouane InstaPrism results.xlsx", sheet = 3)
...
#calgb cleaning####
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
calgb_immune <- read_xlsx("CALGB InstaPrism results.xlsx", sheet = 3)
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Clinical Datasets/Subtypes")
...
#matador cleaning####
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
matador_immune <- read_xlsx("Matador InstaPrism results.xlsx", sheet = 3)
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Clinical Datasets")
...
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
aurora_immune <- read_xlsx("Aurora InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
transneo_immune <- read_xlsx("TransNeo InstaPrism results.xlsx", sheet = 3)
...
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization/Instaprism Results")
newton_immune <- read_xlsx("Newton InstaPrism results.xlsx", sheet = 3)
...
combined_standard_test <- combined_standard %>%
  filter(is.na(pcr)) 
...
#Aggregate replicates of cell-state variables
combined_standard$Cancer_Cycling <- rowSums(combined_standard[, c("Cancer Cycling_1", "Cancer Cycling_2", "Cancer Cycling_3", "Cancer Cycling_4", "Cancer Cycling_5", "Cancer Cycling_6", "Cancer Cycling_7", "Cancer Cycling_8")], na.rm = TRUE)
combined_standard$Cancer_Her2 <- rowSums(combined_standard[, c("Cancer Her2 SC_1", "Cancer Her2 SC_2", "Cancer Her2 SC_3", "Cancer Her2 SC_4", "Cancer Her2 SC_5", "Cancer Her2 SC_6")], na.rm = TRUE)
combined_standard$Cancer_LumB <- rowSums(combined_standard[, c("Cancer LumB SC_1", "Cancer LumB SC_2", "Cancer LumB SC_3", "Cancer LumB SC_4", "Cancer LumB SC_5")], na.rm = TRUE)
combined_standard$Cancer_LumA <- rowSums(combined_standard[, c("Cancer LumA SC_1", "Cancer LumA SC_2", "Cancer LumA SC_3", "Cancer LumA SC_4", "Cancer LumA SC_5")], na.rm = TRUE)
combined_standard$Cancer_Basal <- rowSums(combined_standard[, c("Cancer Basal SC_1", "Cancer Basal SC_2", "Cancer Basal SC_3", "Cancer Basal SC_4", "Cancer Basal SC_5", "Cancer Basal SC_6", "Cancer Basal SC_7", "Cancer Basal SC_8")], na.rm = TRUE)
combined_standard <- combined_standard %>% 
...
colnames(combined_standard[,25:73])
...
combined_standard <- combined_standard %>%
  filter(!is.na(Myoepithelial))

#export to xlsx
setwd("~/Library/CloudStorage/OneDrive-CRUKCambridgeInstitute/Immune Characterization")
write.table(combined_standard, "Clinical Associations with Cell States.txt", row.names = FALSE)
